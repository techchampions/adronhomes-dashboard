...
const Toast = ({ duration = 5000 }) => {
  ...
  return (
    <div className="fixed top-5 left-1/2 transform -translate-x-1/2 flex items-start w-full max-w-xs p-1 text-gray-500 bg-white rounded-lg shadow-lg transition-transform animate-slideInRight z-[90]">
      <div
      ...
      <div className="ml-3 text-sm font-medium text-left line-clamp-2">
        {message}
      </div>
      <button
        type="button"
